...
const pageSubtitles = {
  ...
  '/email-report': 'Detailed email sending report and delivery activity',
...
export default function Header({ onMenuToggle, onToggleCollapse }) {
  ...
  const title = pageTitles[pathname] || 'ANS GHL'
        ...
        <div className="flex items-center gap-2 md:gap-3">
          ...
          <div ref={userMenuRef} className="relative">
            <button
              ...
              className="flex items-center gap-1.5 hover:bg-slate-50 dark:hover:bg-slate-800 rounded-lg px-2 py-1.5 transition-colors"
            >
              ...
              <ChevronDown size={14} className={`text-slate-400 transition-transform hidden sm:block ${showUserMenu ? 'rotate-180' : ''}`} />
            </button>
                ...
                <div className="px-4 py-3 border-b border-slate-100 dark:border-slate-700">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="min-w-0">
                      ...
                      <div className="text-xs text-slate-400 dark:text-slate-500 truncate">{email}</div>
                    </div>
                  </div>
                </div>
